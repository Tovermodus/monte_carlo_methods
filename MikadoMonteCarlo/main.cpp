...
int main()
{
	...
	MediumParameters params(0.05 * scale, 0.001 * scale, IRON_DENSITY, 10, 300 / scale / scale, 5000, WATER_DENSITY,
				WATER_VISCOSITY, true, 1 * scale, 1 * scale, 0, ROOM_TEMPERATURE);
